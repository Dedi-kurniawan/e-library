...
<div class="form-group form-float {!! $errors->has('cover') ? 'has-error' : '' !!}">
	<div class="form-line">
		 ...
		 <label class="help-info">Cover harus berekstensi .jpg .jpeg .bmp .gif .png</label>
</div>
	</div>
...
<div class="form-group form-float {!! $errors->has('author') ? 'has-error' : '' !!}">
	...
	<div class="form-line">
		 ...
		 {!! Form::hidden('type',2, ['class'=>'form-control', 'placeholder' => 'type']) !!}
...
<div class="form-group form-float {!! $errors->has('file') ? 'has-error' : '' !!}">
	<div class="form-line">
		 ...
		 {!! Form::text('file', null, ['class'=>'form-control', 'placeholder' => 'Pastekan url video youtube']) !!}
		 {!! $errors->first('file', '<p class="help-block">:message</p>') !!}
		 <label class="help-info"> Inputkan url dari youtube</label>
</div>
	</div>
...
<div class="form-group form-float ">
	<div class="form-line">
     ...
     {!! Form::select('status', ['1' => 'Free', '2' => 'Premium'], null, ['class' => 'form-control show-tick', 'data-live-search'=> true]) !!}
      ...
      @endif
      <label class="help-info">Silahkan anda menentukan apakah video yang di upload free atau premium</label>
</div>
	</div>
